...
module.exports = {
	buildMine: {
		...
		reward: "Gold: 30\nCopper Ore: 5",
		winDescription: "A Mine will help you build new structures in your empire! To see the different available buildings type the command `!build`. If you are not pleased with one of your buildings you can remove it with the command `!destroy <buildingName>`.\n**A new quest is available. To check it out type `!quest`**",
	...
	preparingYourHero: {
		name: "Preparing Your Hero",
		description: "The newly aquired weapon can be equipped by your hero to increase its combat potency. Equip the Bronze Sword on your hero with the command `!equip bronze sword`.",
