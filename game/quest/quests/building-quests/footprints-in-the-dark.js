...
module.exports = {
    footprintsInTheDark: {
        ...
        execute: async function(user, choice) {
            ...
            const choiceNumber = choice.slice(choice.length - 1);
