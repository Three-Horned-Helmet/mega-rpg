...
module.exports = {
    ...
    childSupport: {
        ...
        execute: async function(user) {
            ...
            user.removeItem(allItems["bronze sword"], false, 15);
            user.addOrRemoveUnits(allUnits["peasant"], -15, true);
