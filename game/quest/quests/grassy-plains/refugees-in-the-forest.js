...
module.exports = {
    ...
    refugeesInForest: {
        ...
        dealingWithWolves: {
            ...
            winDescription: "'You once again saved our people, %username%! We are forever grateful, and if we can ever repay the debt, you tell us!'",
            questKeySequence: ["Grassy Plains", "dealingWithWolves"],
        ...
        wolfPack: {
            name: "The Wolf Pack",
            found: "You found no Alph Wolf among the pack. Better go back to the Forest and search more.",
            pve: [{
                name: "Forest",
                completed: false,
                chance: 0.3,
