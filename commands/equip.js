...
module.exports = {
	name: "equip",
	description: "Equip items for your hero. Make sure you have crafted an item to equip. Try `!equip` to see all your available equipment, or `!equip bronze sword` to equip an item",
